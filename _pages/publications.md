...
<li class="flex-item">
  ...
  <a href="http://dx.doi.org/{{ publi.doi }}" target="blank"><button class="btn-doi">DOI</button></a>
  <button class="btn-fund1">{{ publi.fund }}</button>
  <button class="btn-comp1">{{ publi.comp }}</button>
