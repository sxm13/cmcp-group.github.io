...
<li class="flex-item">
  ...
  {% if publi.doi %}<a href="http://dx.doi.org/{{ publi.doi }}" target="blank"><button class="btn-doi">DOI</button></a> {% endif %}
  {% if publi.nrf-2016 == true %}<button class="btn-nrf-2016">NRF-2016R1D1A1B03934484</button><% endif %>
  {% if publi.nrf-2020 == true %}<button class="btn-nrf-2020">NRF-2020R1C1C1010373</button><% endif %>
  {% if publi.ksc-2019 == true %}<button class="btn-ksc-2019">KSC-2019-CRE-0203</button><% endif %>
  {% if publi.ksc-2020 == true %}<button class="btn-ksc-2020">KSC-2020-CRE-0013</button><% endif %>
